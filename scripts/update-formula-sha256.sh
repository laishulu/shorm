...
sed -i.bak \
    ...
    -e "/url.*shorm-macos-arm64/{ n; s/sha256 \".*\"/sha256 \"$macos_arm64_sha256\"/; }" \
    -e "/url.*shorm-macos-x86_64/{ n; s/sha256 \".*\"/sha256 \"$macos_x86_64_sha256\"/; }" \
    -e "/url.*shorm-linux-x86_64/{ n; s/sha256 \".*\"/sha256 \"$linux_x86_64_sha256\"/; }" \
    homebrew/shorm.rb
